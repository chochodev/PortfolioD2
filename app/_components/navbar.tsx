...
const Navbar: React.FC = () => {
  ...
  // Interface
  return (
    <header className="bg-teal-800/90 backdrop-blur-[20px] sticky z-[200] top-0 left-0 w-full h-[6rem] flex justify-between align-center gap-x-[.5rem] px-[1rem] md:px-[3rem] shadow-[0_2px_15px_2px_rgba(0,0,0,0.25)] ">
      {/* NAV LOGO */}
