  ...
  return (
    <section className="w-full min-h-[100vh] flex flex-col gap-y-[2.5rem]">
      <div className="w-full h-max flex justify-evenly items-center text-center flex-wrap gap-x-[.5rem] gap-y-[2.5rem] px-[1rem+5vw]">
        ...
        />
        <div className="w-[80%] md:w-[40%] md:min-w-[35rem] h-[20rem] flex text-center justify-center flex-col p-[2vw+1rem] rounded-md border-2 border-primary">
          <p className="w-full h-max text-[1.05rem] text-textDark spacing-x-[.15rem] leading-[2rem]">
      ...
      {/* AS A DEVELOPER */}
      <div className="w-full flex flex-col md:flex-row justify-evenly gap-x-[5vw]">
        <div className="bg-textDark min-w-[20rem] flex flex-col items-center text-center gap-y-[1rem] p-[2vw+2rem] rounded-lg">
