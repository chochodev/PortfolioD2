...
const AboutSection: React.FC<SectionType> = ({extra_styles}) => {
  return (
    <section className={`bg-darkSurface flex flex-col gap-y-[2.5rem] ${extra_styles}`}>
      <div className="w-full h-max flex flex-row-reverse justify-evenly items-center text-center flex-wrap gap-x-[.5rem] gap-y-[2.5rem]">
        ...
        />
        <div className="w-[80%] md:w-[50%] h-max flex justify-center text-start flex-col gap-y-[.875rem] rounded-md border-2 border-primary leading-[1.5rem]">
          <p className="w-full h-max text-[1.07rem] text-white spacing-x-[.15rem]">
